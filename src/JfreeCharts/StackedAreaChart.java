...
public class StackedAreaChart {
    ...
    public StackedAreaChart() {
        ...
        JFreeChart Chart = ChartFactory.createStackedAreaChart("Stacked Area CHART", "Degree", "Enrolment", data);
      
        CategoryPlot p = Chart.getCategoryPlot();
        p.setRangeGridlinePaint(Color.black);
        ChartFrame frame = new ChartFrame("Stacked Area Chartt", Chart);
